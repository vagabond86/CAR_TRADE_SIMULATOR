        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 5:
                    ...
                    List<Customer> potentialCustomers = customer.generatePotentialCustomers();
                    for (Customer currentCustomer : potentialCustomers) {
                        System.out.println(currentCustomer.getFirstName() + " " + currentCustomer.getLastName() + ", budżet: " + currentCustomer.getBudget() + " PLN, tel.: " + currentCustomer.getPhoneNumber());
                    }
                    break;
                case 6:
                    break;
